...
<title>DataSystems Portal</title>
	...
	window.open("datasystems_qaqueue_updateqaassignments.php?qaqueueid=" + qaqueueid,"_blank","toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,width=450,height=500");
	}
	</script>
...
<body>
		...
		<div class="leftpane">
		      <div class="navigationcontainer">
				  <ul>
					  ...
					  <li><a  class="active" href="./datasystems_Qa_queue_QA_Assignments.php">QA Assignments</a></li>
		...
		<?
		 //pagination Begin here 
					  ...
					  ##count how many records in total in the database 
					   $select_total_records="select * from DBS_QAQUEUE where DB_Status='Ready QA' OR DB_Status='Waiting Information(QA)' OR DB_Status='QA in Progress'";
		...
		<div class="container">
		   ...
		   {?>
			   <a href ="./datasystems_Qa_queue_QA_Assignments.php?page=<?echo $i;?>&isvalidlogin=1&norecsget=<? echo $page_display_limit;?>" <?if ($page==$i){ echo "class=active";}?>><? echo  " ".$i." "?></a>		   
		<?	   
		   }
      ?>
			<a href="#">&raquo;</a></div>
				...
				<!-- table to get the values --> 
				 <table width=1300 align="center" id="myTable" class="tablesorter">
					  ...
					  <tr>
						   ...
						   <td class="header" width=40 height="40">QA Priority</td>
						   <td class="header" width=300 height="40">QA Team Comments</td>
						   ...
						   <td class="header" width=100 height="40">QA Personal</td>
						   <td class="header" width=50 height="40" >DB Status</td>
						   <td class="header" width=50 height="40" >QA complete date</td>
					  ...
					  <?
					    ...
					    ###retrive select result
							$select_records="select * from DBS_QAQUEUE where DB_Status='Ready QA' OR DB_Status='Waiting Information(QA)' OR DB_Status='QA in Progress' OR DB_Status='Ready QA(Emergency Database)' order by queuID limit $query_limit, $page_display_limit";		   
						   ...
						   while ($row_queue=mysqli_fetch_array($result))
							{
								...
								$QAComments=$row_queue[19];
                                $qa_completedate=$row_queue[20];
                                $qa_Assignment=$row_queue[21];
									...
									<tr>
									     <? if ($Pick_release==1)
										  ...
										  <?}?>
										   ...
										   <td class="record_even" width=300 height="20"><? echo $QAComments;?></td>
										   ...
										   <td class="record_even" width=100 height="20"><? echo $qa_Assignment;?></td>
										   ...
										   <?
									   if ($usertype=='L' || $usertype=='M' || $usertype=='QA')
									   {?>	
								...
								else 
								{
									...
									<? if ($Pick_release==1)
										  ...
										  <?}?>
										   ...
										   <td class="record_Odd" width=300 height="20"><? echo $QAComments;?></td>
										   ...
										   <td class="record_Odd" width=100 height="20"><? echo $qa_Assignment;?></td>
