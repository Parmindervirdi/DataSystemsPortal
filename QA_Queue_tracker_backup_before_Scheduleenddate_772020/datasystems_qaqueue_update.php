...
if (isset ($_POST["controlflow"]))
{
	...
	$update_cb="update dbs_customerbase set CWVersion='$cwversion' ,updatedby='$username',updateddate=now()  where CustomerID=$customerID";
	echo $update_cb;
					      ...
					      <table width=400 align="center">
							   ...
							   <tr> 
							    ...
							    <tr id='test'> 
								   ...
								   <td class="record_odd"><input type="Text" name="exportnumber"></td>
							   </tr>
							   <tr id='test1'> 
							       <td class="record_even">TeamCity Link:</td>
								   <td class="record_even"><input type="Text" name="teamcitylink"></td>
							   </tr>
