...
#####find current date and add 7 days to the current days 

$currentdate=date("Y-m-d");
//echo $currentdate;
$currentdate = strtotime($currentdate);
$todate=strtotime("+7 day", $currentdate);
...
<body>
		...
		<div class="leftpane">
		      <div class="navigationcontainer">
				  <ul>
					  ...
					  <li><a class="active" href="./datasystems_Qa_queue_weekendDBs.php">Weekend Support</a></li>
		...
		<?
		 //pagination Begin here 
					  ...
					  ##count how many records in total in the database 
					   $select_total_records="select * from DBS_QAQUEUE where Actination_Date between  str_to_date('$currentdate','%Y-%m-%d') and  str_to_date('$todate','%Y-%m-%d')";
					   //echo $select_total_records;
		...
		<div class="container">
			...
			//echo $total_records."fgdfgdfgdfdfgdfgdfgdfgdffdgdfgdf";
				 ...
				 <table width=1300 align="center" id="myTable" class="tablesorter">
					  ...
					  <?
					    ...
					    ###retrive select result
							$select_records="select * from DBS_QAQUEUE where Actination_Date between  str_to_date('$currentdate','%Y-%m-%d') and  str_to_date('$todate','%Y-%m-%d') order by queuID limit $query_limit, $page_display_limit";		   
							//echo $select_records;
						   ...
						   while ($row_queue=mysqli_fetch_array($result))
							{
								...
								if ($while_control % 2==0)
								{
									...
									<tr>
									   ...
									   {?>	
										   <td class="record_even" width=100 height="20">
										   <?
											       if ($dbstatus<>"Released") {?><img src="./images/reddot.png" height="12" width="12"><?}else{?><img src="./images/greendot.png" height="12" width="12"><?}
										   
											   ?>
										   <button type='button' class="button_edit button2_edit" onclick="openWin(<?echo $queueID;?> )">Edit</button></td>
				                    <?}
								   else
									   {
										   if ($dbstatus<>"Released")
										   {?>
								           <td class="record_even" width=100 height="20"><img src="./images/reddot.png" height="20" width="20"></td>
									       <?
										   }
										   else 
										   {?>
								...
								else 
								{
									...
									<tr>
                                        ...
                                        <?										   
										   if ($usertype=='L' || $usertype=='M')
									   {?>	
										   <td class="record_Odd" width=100 height="20">
										       <?
											       if ($dbstatus<>"Released") {?><img src="./images/reddot.png" height="12" width="12"><?}else{?><img src="./images/greendot.png" height="12" width="12"><?}
				                    ...
				                    <?}
								   else
									   {
								           if ($dbstatus<>"Released")
										   {?>
								           <td class="record_Odd" width=100 height="20"><img src="./images/reddot.png" height="20" width="20"></td>
									       <?
										   }
										   else 
										   {?>
