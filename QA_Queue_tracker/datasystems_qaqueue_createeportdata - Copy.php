...
if (isset ($_POST["controlflow"]))
{
	...
	$insert_exportdata="Insert into exportcreated (DatabaseID,CustomerID,ExportNumber,TeamcityLink,DateAdded,Addedby,DevNote,TestType) values ($qid,'$customer','$exportnumber','$teamcitylink',CURDATE(),'$username','$devnote','$testtype')";
