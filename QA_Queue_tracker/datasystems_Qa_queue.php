...
<title>DataSystems Portal</title>
	...
	window.open("datasystems_qaqueue_update.php?qaqueueid=" + qaqueueid,"_blank","toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,width=550,height=550");
	}
	
	function open_new_Win() {
	window.open("datasystems_qaqueue_add_new.php","_blank","toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,width=550,height=550");
	}
	
	function openWin_createexport(qaqueueid) {
	window.open("datasystems_qaqueue_createeportdata.php?qaqueueid=" + qaqueueid,"_blank","toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,width=540,height=300");
	}
	</script>
				...
				<!-- table to get the values --> 
				 <table width=1300 align="center" id="myTable" class="tablesorter">
					  ...
					  <tr>
						   ...
						   <td class="header" width=200 height="40">Database Comments</td>
						   ...
						   <td class="header" width=100 height="40">Sch Start/End</td>
						   ...
						   <td class="header" width=50 height="40" >Export</td>
									...
									<tr>
									     <? if ($Pick_release==1)
										  ...
										  <?}?>
										   ...
										   <td class="record_even" width=200 height="20"><? echo $comments;?></td>
										   ...
										   <td class="record_even" width=100 height="20"><? echo $schstart."/".$schend;?></td>
									   ...
									   {?>	
				                           ...
				                           <td class="record_even" width=100 height="20"><button type='button' class="button_edit button2_edit" onclick="openWin_createexport(<?echo $queueID;?> )">Add Export</button></td>
								...
								else 
								{
									...
									<? if ($Pick_release==1)
										  ...
										  <?}?>
										   ...
										   <td class="record_Odd" width=100 height="20"><? echo $schstart."/".$schend;?></td>
									   ...
									   {?>	
										   ...
										   <td class="record_Odd" width=100 height="20"><button type='button' class="button_edit button2_edit" onclick="openWin_createexport(<?echo $queueID;?> )">Add Export</button></td>
				                    <?}
								   else
									   {?>
								           <td class="record_Odd" width=100 height="20"><button type='button' class="button_edit button2_edit" onclick="openWin_createexport(<?echo $queueID;?> )">Add Export</button></td>
